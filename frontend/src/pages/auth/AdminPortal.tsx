...
const styles = {
  page:
    "min-h-[100dvh] bg-[linear-gradient(180deg,#F7FAF8_0%,#F1F5F2_60%,#EDF2EF_100%)] text-[#0E1A15]",
  shell: "mx-auto flex min-h-[100dvh] w-full max-w-6xl flex-col gap-4 px-3 py-4 sm:gap-5 sm:px-5 sm:py-6",
  glass:
    "overflow-hidden rounded-[1.35rem] border border-[#E3E9E5] bg-white shadow-[var(--shadow-md)] sm:rounded-[1.6rem]",
  card:
    "rounded-[1.35rem] border border-[#E3E9E5] bg-white shadow-[var(--shadow-md)] sm:rounded-[1.6rem]",
  input:
    "h-11 rounded-xl border-[#E3E9E5] bg-white text-[#0E1A15] placeholder:text-slate-400 focus:border-[#00A859] focus:ring-[#00A859]/12",
  select:
    "h-11 w-full rounded-xl border border-[#E3E9E5] bg-white px-4 text-sm font-semibold text-[#0E1A15] shadow-[var(--shadow-sm)] outline-none transition focus:border-[#00A859] focus:ring-4 focus:ring-[#00A859]/10",
  primary:
    "rounded-xl bg-[#00A859] font-bold text-white shadow-[var(--shadow-sm)] transition hover:bg-[#07934E] active:translate-y-px disabled:opacity-50",
  secondary:
    "rounded-xl border border-[#E3E9E5] bg-white font-bold text-[#0B3D29] shadow-[var(--shadow-sm)] transition hover:bg-[color:var(--accent)]",
}
          ...
          <section className="flex min-h-[560px] items-center justify-center bg-white px-5 py-8 sm:min-h-[620px] sm:px-12 sm:py-10">
            <div className="w-full max-w-[360px]">
              ...
              <div className="space-y-4">
                ...
                <Button
                  className="mt-3 h-[52px] w-full rounded-full bg-[#00A859] font-bold text-white shadow-[var(--shadow-sm)] transition hover:bg-[#07934E] active:translate-y-px disabled:opacity-50"
