    ...
    return (
      <AppLayout>
        <div className="flex h-64 items-center justify-center">
          <div className="rounded-3xl border border-slate-200 bg-white px-6 py-4 text-sm font-medium text-slate-700 shadow-sm">
  ...
  return (
    <AppLayout>
      <div className="max-w-7xl mx-auto w-full space-y-8 py-6">
        <div className="rounded-[2rem] border border-blue-400/30 bg-gradient-to-br from-slate-950 via-blue-950 to-blue-700 text-slate-950 p-6 shadow-[0_25px_70px_rgba(15,23,42,0.35)] sm:p-8">
        ...
        <Card className="rounded-[2rem] border border-slate-200 bg-white shadow-[0_20px_60px_rgba(15,23,42,0.28)]">
          <CardHeader>
            <CardTitle className="flex items-center gap-3 text-xl font-bold tracking-[-0.02em] text-slate-950">
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={sectorFilter} onValueChange={setSectorFilter}>
                  <SelectTrigger className="h-11 rounded-2xl border border-slate-200 bg-white text-slate-900">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-4">
              ...
              <div className="space-y-2">
                <label className="text-sm text-slate-500">Prioridade</label>
                <Select
            ...
            <div className="flex flex-col gap-4 rounded-[1.5rem] border border-slate-200 bg-blue-50/60 p-4 text-sm text-slate-500 sm:flex-row sm:items-center sm:justify-between">
              <div className="min-w-0">
                <p>
                  <strong className="text-slate-950">{filteredTickets.length}</strong>{" "}
              ...
              <Button
                ...
                variant="outline"
                className="inline-flex items-center justify-center rounded-full border border-blue-200 bg-white px-5 py-2 text-sm font-bold text-blue-700 transition hover:bg-blue-50"
            >
        ...
        <div className="space-y-6">
          <section>
            <h3 className="mb-4 text-sm uppercase tracking-[0.16em] text-slate-600">
              Resumo por status
            </h3>
        ...
        <Card className="rounded-[2rem] border border-slate-200 bg-white shadow-[0_20px_60px_rgba(15,23,42,0.28)]">
          <CardHeader>
            <CardTitle className="text-xl font-bold tracking-[-0.02em] text-slate-950">
              Preview dos dados
            </CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <table className="min-w-[900px] w-full text-sm">
                <thead>
                  <tr className="border-b border-slate-200">
                    ...
                    <th className="text-left p-3 text-slate-500">Solicitante</th>
                    <th className="text-left p-3 text-slate-500">Setor</th>
                    <th className="text-left p-3 text-slate-500">Categoria</th>
                    <th className="text-left p-3 text-slate-500">Status</th>
                    <th className="text-left p-3 text-slate-500">Origem</th>
                    <th className="text-left p-3 text-slate-500">Prioridade</th>
                    <th className="text-left p-3 text-slate-500">Criado em</th>
                  </tr>
                </thead>
                <tbody>
                  {filteredTickets.slice(0, 20).map((ticket) => (
                    <tr
                      key={ticket.id}
                      className="border-b border-slate-200 transition hover:bg-blue-50"
                    >
                      <td className="p-3 text-slate-950">#{ticket.id}</td>
                      <td className="p-3 text-slate-950">{ticket.user}</td>
                      <td className="p-3 text-slate-950">{ticket.sector}</td>
                      <td className="p-3 text-slate-950">{ticket.category}</td>
                      <td className="p-3">
                        <span
                      ...
                      <td className="p-3 text-slate-950">{ticket.origin}</td>
                      <td className="p-3 text-slate-950">{ticket.priority}</td>
                      <td className="p-3 text-slate-950">{ticket.createdAt}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
