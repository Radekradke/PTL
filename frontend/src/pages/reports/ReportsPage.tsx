    ...
    <AppLayout>
      <div className="mx-auto w-full max-w-7xl space-y-7 py-4">
        <section className={`${metallicPanel} p-5 text-white sm:p-8`}>
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0">
              <p className="text-xs font-bold uppercase tracking-[0.24em] text-emerald-100/85">Central de relatórios</p>
        ...
        <Card className={`${metallicCard} text-white`}>
          <CardHeader>
            <CardTitle className="flex items-center gap-3 text-xl font-black tracking-[-0.03em] text-white"><span className="rounded-2xl border border-white/10 bg-white/10 p-2 text-emerald-100"><FileText size={20} /></span>Filtros</CardTitle>
          </CardHeader>
