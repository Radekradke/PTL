  ...
  return (
    <AppLayout>
      <div className="max-w-7xl mx-auto w-full space-y-8 py-4">
        <div className="rounded-[2rem] border border-blue-400/30 bg-gradient-to-br from-slate-950 via-blue-950 to-blue-700 text-white p-6 shadow-[0_25px_70px_rgba(15,23,42,0.35)] sm:p-8">
          <div className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              <div className="rounded-3xl border border-white/10 bg-white/10 backdrop-blur-xl p-4 text-center">
              ...
              <div className="rounded-3xl border border-amber-300/20 bg-amber-400/10 backdrop-blur-xl p-4 text-center">
                <p className="text-xs uppercase tracking-[0.2em] text-amber-100">Pendentes</p>
                <p className="mt-3 text-3xl font-semibold text-amber-100">{openTickets + waitingUserTickets}</p>
              </div>
              <div className="rounded-3xl border border-cyan-300/20 bg-cyan-400/10 backdrop-blur-xl p-4 text-center sm:col-span-2 lg:col-span-1">
                <p className="text-xs uppercase tracking-[0.2em] text-cyan-100">Em atendimento</p>
                <p className="mt-3 text-3xl font-semibold text-cyan-100">{progressTickets}</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm uppercase tracking-[0.16em] text-slate-600 mb-4">
                Resumo por status
              </h3>
